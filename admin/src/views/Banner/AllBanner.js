...
function AllHero() {
    ...
    const handleUpdateStatus = async (id, currentStatus) => {
        try {
            ...
            await axios.put(`https://www.api.propsavvyrealtors.com/api/v1/update_hero_status/${id}`, {
    ...
    const handleDeleteHero = async (id) => {
        try {
            setLoading(true);
            await axios.delete(`https://www.api.propsavvyrealtors.com/api/v1/delete_hero/${id}`);
