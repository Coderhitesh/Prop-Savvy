...
function AllTestimonial() {
    ...
    const handleFetchBanner = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://api.propsavvyrealtors.com/api/v1/get-all-testimonial');
    ...
    const handleUpdateActive = async (id, currentStatus) => {
        ...
        try {
            ...
            const res = await axios.put(`https://api.propsavvyrealtors.com/api/v1/update-testimonial-status/${id}`, {
    ...
    const handleDeleteBanner = async (id) => {
        setLoading(true);
        try {
            await axios.delete(`https://api.propsavvyrealtors.com/api/v1/delete-testimonial/${id}`);
