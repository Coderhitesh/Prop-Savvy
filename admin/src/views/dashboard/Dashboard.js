...
const Dashboard = () => {
  ...
  const fetchProviders = async () => {
    try {
      const { data } = await axios.get('http://localhost:8000/api/v1/get-all-provider');
  ...
  const handleFetchChat = async () => {
    try {
      const { data } = await axios.get('http://localhost:8000/api/v1/get-all-chat-record');
  ...
  const handleFetchRecharge = async () => {
    try {
      const { data } = await axios.get('http://localhost:8000/api/v1/total-recharge-amount');
  ...
  const handleFetchWithdraw = async () => {
    try {
      const { data } = await axios.get('http://localhost:8000/api/v1/total-withdraw-and-commission');
      setAllWithdraw({
