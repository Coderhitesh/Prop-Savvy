...
const testimonials = [
  {
    ...
    content: "Prop Savvy Realtors made my dream of owning a home a reality. Their expertise and dedication throughout the entire process was exceptional. I couldn't be happier with my new home!",
    rating: 5,
  ...
  },
  {
    ...
    content: "As an investor, I appreciate their market knowledge and professional approach. They helped me find properties with great potential and handled everything seamlessly.",
    rating: 5,
  ...
  },
  {
    ...
    content: "The team at Prop Savvy Realtors went above and beyond to help me find my first home. Their patience and guidance made the process stress-free and enjoyable.",
    rating: 5,
    location: "Miami, FL"
  }
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Join hundreds of satisfied clients who found their perfect property with Prop Savvy Realtors
          </p>
        </div>
